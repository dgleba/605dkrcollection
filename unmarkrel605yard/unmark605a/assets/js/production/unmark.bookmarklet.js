...
!function(l) {
    ...
    unmark.updateDom = function() {
        ...
        var n = e.data("panel") ? e.data("panel") : "", t = "" !== n ? n.replace(/^#/, "") : "", r = -1 !== t.indexOf("label"), i = -1 !== e.attr("href").indexOf("label"), o = -1 !== t.indexOf("tags"), s = -1 !== e.attr("href").indexOf("tag"), l = -1 !== t.indexOf("archive"), u = !1;
        return (r || i) && (n = "#" + (t = "panel-label"), u = !0), (o || s) && (n = "#" + (t = "panel-tags"), 
        !o && s ? u = !0 : o && !s && (u = !1)), l && (u = !0), d(".menu-item").removeClass("active-menu"), 
        ...
        t = Hogan.compile(unmark.template.marks), e = window.location.pathname, pages_already_loaded[s] = !0, 
        unmark.ajax(e + "/" + s, "post", "", function(a) {
            if (a.marks) {
                ...
                unmark.main_content.find(".marks_list").append(i), window.unmark_current_page = s, 
                o = !1;
            }
        }));
    ...
    unmark.show_mark_info = function(a) {
        ...
        r.mark_title = l;
        var u = "", d = Object.keys(r.tags).length, m = 1;
        for (var c in r.tags) void 0 !== c && (u += m == d ? c.toString() : c.toString() + ",", 
        m++);
        r.tags_string = u, Modernizr.mq("only screen and (min-width: 768px)") && (k(".mark").removeClass("view-inactive").removeClass("view-active"), 
        k(".mark").not("#mark-" + o).addClass("view-inactive"), k("#mark-" + o).addClass("view-active")), 
        k(".sidebar-content").addClass("active"), "" !== s && (r.notes = s), e = Hogan.compile(unmark.template.sidebar).render(r), 
        ...
        unmark.sidebar_mark_info.html(e), function a() {
            ...
            intervalSaveTitle = setInterval(function() {
                e.hasClass("contentsChanged") && (unmark.saveTitle(o, e.val()), k("#mark-" + o + " h2 a").html(e.val()), 
                e.removeClass("contentsChanged"));
            }, 1e3), intervalSaveNotes = setInterval(function() {
                t.hasClass("contentsChanged") && (unmark.saveNotes(o, t.val()), t.removeClass("contentsChanged"));
                ...
                ajax_loading = !1, e = tagList, n.selectize({
                    ...
                    onChange: function(a) {
                        unmark.saveTags(o, a), setTimeout(unmark.update_tag_count, 1e3);
                    }
                });
            });
        });
        ...
        o.on("keydown", function(a) {
            ...
            var e, n, t, r;
            a.preventDefault(), 13 !== a.which && "blur" !== a.type || (o.hasClass("contentsChanged") || editable_mark_title.hasClass("contentsChanged")) && (e = editable_mark_title.text(), 
            n = o.text(), t = s, "" !== e && (i = "title=" + unmark.urlEncode(e) + "&notes=" + unmark.urlEncode(n) + "&tags=" + unmark.urlEncode(t), 
        ...
        l.length < 1 && (l = k(".label-choices"), d = k(".mark-added-label"), m = !0), l.find("a").unbind(), 
        l.find("a").on("click", function(a) {
            a.preventDefault(), e = l.data("id"), n = k(this).attr("rel"), r = k(this).text(), 
            i = k("body").attr("class"), o = new RegExp("label"), t = "label_id=" + n, s = k('.action[data-id="' + e + '"][data-action="marks_addLabel"]'), 
            unmark.ajax("/mark/edit/" + e, "post", t, function(a) {
                u.text(r), m ? (k("#currLabel").text(r), unmark.swapClass(k("#currLabel"), "label-*", "label-" + n), 
                unmark.swapClass(d, "label-*", "label-" + n)) : (s.text(r), unmark.swapClass(s, "label-*", "label-" + n), 
                unmark.swapClass(d, "label-*", "label-" + n), unmark.swapClass(k("#mark-" + e), "label-*", "label-" + n)), 
                unmark.update_label_count(), unmark.update_mark_info(a, e), o.test(i) && i !== "label-" + n && (k("#mark-" + e).fadeOut(), 
    ...
    d(document).ready(function() {
        ...
        function u(a) {
            ...
            l.prepend(e), unmark.marks_addLabel();
        }
        a = r.data("label"), e = r.data("label-name"), n.addClass("label-" + a).text(e), 
        unmark.ajax("/tags/getAutocomplete", "get", "", function(a) {
            if (tagList = [], a.error && console.log(a.error), !1 !== a.tags) for (i = 0; i < Object.keys(a.tags).length; i++) tagList.push({
                text: a.tags[i].name
            });
            for (mark_added_tags_value = s.val().split(","), i = 0; i < mark_added_tags_value.length; i++) tagList.push({
                text: mark_added_tags_value[i]
            });
            var e;
            ajax_loading = !1, e = tagList, s.selectize({
                plugins: [ "remove_button", "restore_on_backspace" ],
                delimiter: ",",
                openOnFocus: !1,
                persist: !1,
            ...
            if (13 === a.which || "blur" === a.type) {
                a.preventDefault();
                var e = d(this).val(), n = d(this).data("id"), t = d(".mark-added-info h1").text();
                unmark.saveNotes(n, e, t);
            }
        }), t.on("click", function(a) {
            var e = s[0].selectize;
            e.createItem(d(this).html().replace("#", "")), e.focus();
        });
    });
